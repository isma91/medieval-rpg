...
<div class="container">
        ...
        foreach ($personnage as $value) {
            ...
            <div class="col-lg-6 col-sm-10 text-center">
                <?php if ($value->picture == null) {
                    ...
                    ?>
                    <img class="img-circle img-responsive img-center avatar" src="{!! url() !!}/avatarPersonnage/<?php echo $value->picture; ?>" alt="$value->name">
                    <?php
                } ?>
                <h3><?php echo $value->name; ?>
                    <small>Level : <?php echo $value->level ?></small>
    ...
    <div class="form-group">
        {!! Form::label('degas', 'Choisissez votre attaque :') !!}
    ...
    <div class="form-group">
        {!! Form::submit('Attaque !!', ['class' => 'btn btn-primary form-control', 'id' => 'attaque']) !!}
    </div>
</div>
</body>
</html>