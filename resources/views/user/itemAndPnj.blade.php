...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">{!! Auth::user()->droit !!} {!! Auth::user()->name !!} {!! Auth::user()->lastname !!}
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Tout les items</h2>
        </div>
        <?php
        foreach ($items as $value) {
            ...
            <div class="col-lg-4 col-sm-6 text-center">
                <?php if ($value->picture == null) {
                    ?>
                    <img class="img-circle img-responsive img-center" src="http://placehold.it/200x200" alt="no picture yet !!">
                    <?php
                } else {
                    ?>
                    <img class="img-circle img-responsive img-center" src="{!! url() !!}/items/<?php echo str_replace(' ', '_', $value->picture); ?>" alt="$value->name">
                    <?php
                } ?>
                <h3><?php echo $value->name; ?>
                    <small>Min Level : <?php echo $value->level ?></small>
                </h3>
                <h2>Prix : <?php echo $value->prix; ?></h2>
